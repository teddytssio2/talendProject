package projet3.copy_of_justajob3_5_0;
...
public class Copy_of_JustAJob3 implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Copy_of_JustAJob3.log");
	}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger
			.getLogger(Copy_of_JustAJob3.class);
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Copy_of_JustAJob3.this, new Object[] { e,
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Copy_of_JustAJob3.class
					.getClassLoader().getResourceAsStream(
							"projet3/copy_of_justajob3_5_0/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = Copy_of_JustAJob3.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : Copy_of_JustAJob3");
		}
...
/************************************************************************************************
 * 36068 characters generated by Talend Cloud Data Management Platform on the 15
 * novembre 2018 15:04:52 CET
 ************************************************************************************************/
