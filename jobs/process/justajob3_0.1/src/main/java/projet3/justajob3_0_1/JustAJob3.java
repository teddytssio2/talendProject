...
/**
 * Job: JustAJob3 Purpose: <br>
 * Description:  <br>
 * @author teddy.lequette@hardis.fr
 * @version 7.0.1.20180903_1027-patch
 * @status 
 */
public class JustAJob3 implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "JustAJob3.log");
	}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger
			.getLogger(JustAJob3.class);
	...
	private final String jobName = "JustAJob3";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(JustAJob3.this, new Object[] { e,
	...
	public static class output3Struct implements
		...
		final static byte[] commonByteArrayLock_PROJET3_JustAJob3 = new byte[0];
		static byte[] commonByteArray_PROJET3_JustAJob3 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROJET3_JustAJob3.length) {
					if (length < 1024
							&& commonByteArray_PROJET3_JustAJob3.length == 0) {
						commonByteArray_PROJET3_JustAJob3 = new byte[1024];
					} else {
						commonByteArray_PROJET3_JustAJob3 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROJET3_JustAJob3, 0, length);
				strReturn = new String(commonByteArray_PROJET3_JustAJob3, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROJET3_JustAJob3) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_2 = (new java.io.File(
						"C:/Talend/out.csv")).getAbsolutePath().replace("\\",
						"/");
	...
	public static void main(String[] args) {
		final JustAJob3 JustAJob3Class = new JustAJob3();

		int exitCode = JustAJob3Class.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'JustAJob3' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'JustAJob3' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = JustAJob3.class.getClassLoader()
					.getResourceAsStream(
							"projet3/justajob3_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = JustAJob3.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : JustAJob3");
		}
...
/************************************************************************************************
 * 57074 characters generated by Talend Cloud Data Management Platform on the 29
 * octobre 2018 16:39:43 CET
 ************************************************************************************************/
